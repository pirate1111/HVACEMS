...
public class FileDownloadView implements View{
	...
	public void render(Map<String, ?> model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		String savedAttachFileUrl = (String) model.get("savedAttachFileUrl");
		String attachFileName = (String) model.get("attachFileName");
		
		//보낸파일설정
		File downloadFile = new File(savedAttachFileUrl + File.separator + attachFileName);
		...
		// 한글깨짐 방지 ISO-8859-1
		String sendFileName = attachFileName.split("\\$\\$")[1];
