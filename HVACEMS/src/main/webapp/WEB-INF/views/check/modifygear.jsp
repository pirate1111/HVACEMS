...
<section class="content-header">
	<div class="container-fluid">
		<h1 style="font-size:30px">장비 관리 점검 기록표 수정하기</h1>
	</div>
</section>
		...
		<div class="card-body">
			<div class="row mb-1">
				...
				<div class="col-sm-6" style="text-align: right;">
					<button class="btn btn-primary" type="button" onclick="submit_go('modifyFormgear.do');" style="height:40px">
						수정완료
					</button>
			...
			<div class="row mb-2">
				<div class="col-sm-12">
					<form enctype="multipart/form-data" role="form" method="post" action="modifygear.do" name="modifyFormgear">
...
function submit_go(url){
	if (url == "modifyFormgear.do" && !confirm("점검표 수정을 마치시겠습니까?")) {
		return;
	}
	var form = $('form[name=modifyFormgear]');
	//유효성체크
