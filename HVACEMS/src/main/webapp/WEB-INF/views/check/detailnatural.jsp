		...
		<div class="card-body">
			<div class="row mb-1">
				...
				<div class="col-sm-6" style="text-align: right;">
					<button class="btn btn-primary" type="button" onclick="submit_go('modifyFormnatural.do', '${check.checkNum}');" style="height:40px">
						점검표 수정하기
					</button>
					<button class="btn btn-warning" type="button" onclick="CloseWindow();" style="height:40px">
						창닫기
					</button>
					<button class="btn btn-danger" type="button" onclick="submit_go('removenatural.do', '${check.checkNum}');" style="height:40px">
						점거표 삭제하기
					</button>
				</div>
			</div>
...
function submit_go(url, checkNum) {
	if (url == "modifyFormnatural.do" && !confirm("점검표를 수정하시겠습니까?")) {
		return;
	}
	if (url == "removenatural.do" && !confirm("정말로 삭제하시겠습니까?")) {
		return;
	}
