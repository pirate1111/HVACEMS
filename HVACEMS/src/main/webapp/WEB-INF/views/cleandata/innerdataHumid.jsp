								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-3" align="right">
											...
											<button type="button" class="btn bg-gradient-success" style="margin-left: 5px; width:74px;" onclick="location.href='humidList.do'">리스트</button>
										</div>
									</div>
									<div class="row">
										<div class="col-12" id="chartCanvas">
											<canvas id="humidDetailChart" style="width:100%; height:700px;"></canvas>
										</div>
									</div>
								</div>
							</div>
...
// 			alert(data[0].JSONhumid);
			...
			new Chart(document.getElementById("humidDetailChart"), {
			    type: 'line',
			    data: {
			    	labels: timeList,	
			    	datasets: [{
...
html2canvas(document.getElementById("chartCanvas")).then(function(canvas) {
	...
	var dataUrl = canvas.toDataURL(); //athumidt to save base64 string to server using this var
