								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-3" align="right">
											...
											<button type="button" class="btn bg-gradient-success" style="margin-left: 5px; width:74px;" onclick="location.href='tempList.do'">리스트</button>
										</div>
									</div>
									<div class="row">
										<div class="col-12" id="chartCanvas">
											<canvas id="tempDetailChart" style="width:100%; height:700px;"></canvas>
										</div>
									</div>
								</div>
							</div>
...
// 			alert(data[0].tempDate);
			for(let i = 0; i < data.length; i++){
				timeList.push(data[i].date);
				tempList.push(data[i].temperature);
				sdtempList.push(23.0)
			}

			new Chart(document.getElementById("tempDetailChart"), {
			    type: 'line',
			    data: {
			    	labels: timeList,	
			    	datasets: [{
